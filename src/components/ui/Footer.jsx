    ...
    <footer className="mt-14 flex items-end justify-between px-5 py-4 sm:flex text-body-4 md:text-body-3">
      <div className="flex flex-col md:flex-row md:w-[62.5vw] lg:w-[57.5vw] justify-between">
        <div className="flex space-x-1" >
          <span>&copy;</span>
          <span>2024</span>
          <span className="font-extrabold uppercase 2xl:text-body-1">Bryan Vu</span>
        </div>
        <div>
          <span className=" text-body-4 2xl:text-body-1 snap-center">“Programmer: A machine that turns coffee into code.” </span>
        </div>
      </div>
